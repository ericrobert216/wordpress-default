				...
				<div class="zoo-cw-collapse">
					<table class="zoo-cw-label-data">
						...
						<tr class="zoo_cw_product_swatch_display_size" <?php if ($display_type == 'default') echo('style="display:none;"'); ?> >
							...
							<?php $product_swatch_display_size = isset($product_swatch_data_array[$tmp_title]['product_swatch_display_size']) ? $product_swatch_data_array[$tmp_title]['product_swatch_display_size'] : 'default'; ?>
							<td>
								<select name="zoo_cw_product_swatch_display_size_<?php echo  $attribute_name; ?>">
                                    <option value="default" <?php if($product_swatch_display_size == "default"): echo 'selected=selected'; endif; ?>><?php _e('Default Global','clever-swatch');?></option>
									<option value="1" <?php if($product_swatch_display_size == 1): echo 'selected=selected'; endif; ?>><?php _e('20px * 20px','clever-swatch');?></option>
									<option value="2" <?php if($product_swatch_display_size == 2): echo 'selected=selected'; endif; ?>><?php _e('40px * 40px','clever-swatch');?></option>
									<option value="3" <?php if($product_swatch_display_size == 3): echo 'selected=selected'; endif; ?>><?php _e('60px * 60px','clever-swatch');?></option>
								</select>
							</td>
						</tr>
                        <tr class="zoo_cw_product_swatch_display_shape" <?php if ($display_type == 'default') echo('style="display:none;"'); ?> >
                            ...
                            <?php $product_swatch_display_shape = isset($product_swatch_data_array[$tmp_title]['product_swatch_display_shape']) ? $product_swatch_data_array[$tmp_title]['product_swatch_display_shape'] : 'default'; ?>
                            <td>
                                <select name="zoo_cw_product_swatch_display_shape_<?php echo  $attribute_name; ?>">
                                    <option value="default" <?php if($product_swatch_display_shape == "default"): echo 'selected=selected'; endif; ?>><?php _e('Default Global','clever-swatch');?></option>
                                    <option value="square" <?php if($product_swatch_display_shape == 'square'): echo 'selected=selected'; endif; ?>><?php _e('Square','clever-swatch');?></option>
                                    <option value="circle" <?php if($product_swatch_display_shape == 'circle'): echo 'selected=selected'; endif; ?>><?php _e('Circle','clever-swatch');?></option>
                                </select>
                            </td>
                        </tr>
						<tr class="zoo_cw_product_swatch_display_name" <?php if ($display_type == 'default' || $display_type == 'text') echo('style="display:none;"'); ?>>
							...
							<?php $product_swatch_display_name = isset($product_swatch_data_array[$tmp_title]['product_swatch_display_name_yn']) ? $product_swatch_data_array[$tmp_title]['product_swatch_display_name_yn'] : 'default'; ?>
							<td>
								<select name="zoo_cw_product_swatch_display_name_<?php echo  $attribute_name; ?>">
                                    <option value="default" <?php if($product_swatch_display_name == "default"): echo 'selected=selected'; endif; ?>><?php _e('Default Global','clever-swatch');?></option>
									<option value="1" <?php if($product_swatch_display_name == '1'): echo 'selected=selected'; endif; ?>><?php _e('Yes','clever-swatch');?></option>
									<option value="0" <?php if($product_swatch_display_name == '0'): echo 'selected=selected'; endif; ?>><?php _e('No','clever-swatch');?></option>
								</select>
							</td>
						</tr>
					</table>
